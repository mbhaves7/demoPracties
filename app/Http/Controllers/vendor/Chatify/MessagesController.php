...
//                    $file->storeAs("/" . config('chatify.attachments.folder'), $attachment);
    ...
    public function getContacts(Request $request)
    {
        ...
        {
            $members = User::where('type', '!=', 'client')->where('type', '!=', 'vendor')->where('created_by', '=', $objUser->created_by)->where('id', '!=', $objUser->id)->orWhere('id', '=', $objUser->created_by)->get();
        }
    ...
    public function search(Request $request)
    {
        ...
        $records = User::where('created_by', $id)->where('type', '!=', 'client')->where('name', 'LIKE', "%{$input}%")->get();
