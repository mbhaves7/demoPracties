...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    {
        return $this->hasMany(User::class, 'reporter');
    }
    ...
    public function assignPlan($plan_id = null,$duration = null,$modules = null,$user_count = 0,$user_id = null)
    {
        if($user_id != null)
        {
    ...
    public static function CompanySetting($id = null,$workspace_id = null)
    {
        if(!empty($id))
        {
            ...
            $company_setting = [
                ...
                "title_text" => !empty(admin_setting('title_text')) ? admin_setting('title_text') : "JBDS POWER",
                "footer_text" => !empty(admin_setting('footer_text')) ? admin_setting('footer_text') :"Copyright © Quantmhill",
                "site_rtl" => "off",
                "cust_darklayout" => "off",
                "site_transparent" => "on",
                "color" => "theme-1",
