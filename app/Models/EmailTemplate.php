...
class EmailTemplate extends Model
{
    ...
    public static function sendEmailTemplate($emailTemplate, $mailTo,$obj,$user_id=null,$workspace_id=null, $cc=null)
    {
        if(!empty($user_id)){
                    ...
                    if(!empty(company_setting('mail_from_address',$user_id,$workspace_id)))
                    {
                        ...
                        if($setconfing ==  true)
                        {
                            try
                            {
                                ...
                                $mail->send(new CommonEmailTemplate($content,$user_id,$workspace_id));
                            }
                            catch(\Exception $e)
                            {
                                $error = $e->getMessage();
