...
<?php
    $old_path = url("/Modules/".$module->getName()."/marketplace/");
                    ...
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-image-wrapper">
                            <div class="pdp-media banner-img-wrapper">
                                ...
                                <img src="<?php echo e(check_file($marketplace['product_main_banner']) ? get_file($marketplace['product_main_banner']) : $old_path."/image1.png"); ?>" alt="" class="inner-frame-img">
                        </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row row-gap padding-bottom ">
                                ...
                                <div class="col-lg-7 col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="<?php echo e(check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : $old_path."/image2.png"); ?>" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="row row-gap  padding-bottom">
                                <div class="col-lg-7  col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="<?php echo e(check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : $old_path."/image3.png"); ?>" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                                <div class="col-lg-5 col-md-6 col-12">
                                    <div class="abt-theme">
                    ...
                    <?php $__currentLoopData = json_decode($marketplace['screenshots'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="screenshot-itm">
                            <div class="screenshot-image">
                                <img src="<?php echo e(check_file($marketplace['screenshots']) ? get_file($marketplace['screenshots']) : $old_path."/image3.png"); ?>" alt="" class="inner-frame-img">
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
...
<?php echo $__env->make('landingpage::layouts.marketplace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QuantmHill\erp_system\Modules/LandingPage\Resources/views/marketplace/index.blade.php ENDPATH**/ ?>