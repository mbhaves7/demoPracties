    ...
    public function run()
    {
        ...
        // admin settings
            ...
            $admin_setting = [
                ...
                "title_text" => "JBDS POWER",
                "footer_text" => "Copyright © Quantmhill",
                "landing_page" => "on",
                "site_rtl" => "off",
                "cust_darklayout" => "off",
                "site_transparent" => "on",
                ...
                "meta_title" => "JBDS POWER - Open Source ERP with Multi-Workspace",
                "meta_keywords" => "JBDS POWER,SaaS solution,Multi-workspace functionality, Cloud-based access,Scalability,Multi-addons,Collaboration tool,Data management,Business productivity,Operational effectiveness",
