                                ...
                                <div class="col-lg-4 col-md-6 col-12 support-card">
                                    <div class="support-card-inner">
                                        <div class="support-card-media">
                                            <div class="card-icon">
                                                <?php if(check_file($settings['feature_logo'])): ?>
                ...
                <?php if(is_array(json_decode($settings['other_features'], true)) ||
                    is_object(json_decode($settings['other_features'], true))): ?>
                        <?php $__currentLoopData = json_decode($settings['other_features'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php else: ?>
                                <div class="bg-white padding-bottom padding-top ">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-7  col-md-6 col-12">
                                                <div class="dash-theme-preview">
...
</html><?php /**PATH D:\QuantmHill\erp_system\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>