...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="<?php echo e(company_setting('site_rtl') == 'on'?'rtl':''); ?>">
    <head>
        ...
        <title><?php echo $__env->yieldContent('page-title'); ?> | <?php echo e(!empty(company_setting('title_text')) ? company_setting('title_text') : (!empty(admin_setting('title_text')) ? admin_setting('title_text') :'JBDS Power')); ?></title>

        <meta name="title" content="<?php echo e(!empty(admin_setting('meta_title')) ? admin_setting('meta_title') : 'JBDS Power'); ?>">
        <meta name="keywords" content="<?php echo e(!empty(admin_setting('meta_keywords')) ? admin_setting('meta_keywords') : 'JBDS Power,SaaS solution,Multi-workspace'); ?>">
        ...
        <meta property="og:title" content="<?php echo e(!empty(admin_setting('meta_title')) ? admin_setting('meta_title') : 'JBDS Power'); ?>">
        ...
        <meta property="twitter:title" content="<?php echo e(!empty(admin_setting('meta_title')) ? admin_setting('meta_title') : 'JBDS Power'); ?>">
...
<?php /**PATH D:\QuantmHill\erp_system\resources\views/layouts/main.blade.php ENDPATH**/ ?>