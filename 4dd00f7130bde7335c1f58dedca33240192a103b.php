...
<script>
    $(document).ready(function() {
        if($('#proposal_footer_notes')){
            CKEDITOR.replace('proposal_footer_notes');
        }
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QuantmHill\erp_system\resources\views/settings/index.blade.php ENDPATH**/ ?>