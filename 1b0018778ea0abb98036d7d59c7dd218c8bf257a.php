                ...
                <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                    ...
                    <?php if(Auth::user()->type == "super admin"): ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('language manage')): ?>
                            <a href="<?php echo e(route('lang.index',[Auth::user()->lang])); ?>" class="dropdown-item border-top pt-3 text-primary">
...
<?php /**PATH D:\QuantmHill\erp_system\resources\views/partials/header.blade.php ENDPATH**/ ?>